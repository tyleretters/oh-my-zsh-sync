...
alias ll="ls -laG"
alias nn="npm cache clean --force && rm package-lock.json && rm -rf node_modules && npm i"
alias clearTorus="sudo xattr -dr com.apple.quarantine  '/Library/Application Support/Avid/Audio/Plug-Ins/Torus-*.aaxplugin'"
alias rj="cd ~/projects/royal-jelly"
...
alias box="cd ~/projects/micro-frontend-shopping-box"
